...
- Writes a numbered series of TSVs and heatmaps under `00_logs_and_reports/reports/`:
  ...
  - `08_non_chimeric_paralog_count_heatmap_<assembly_source>_after_sample_threshold_<min_samples_threshold
  > >_filtering_max_count_<cap>_stepped.png` — categorical heatmap of the counts in `06*`. Counts >= `--non_chimeric_paralog_max_count` (default: 10) collapse to the top bucket.
